...
Gem::Specification.new do |spec|
  spec.name          = "quicken-git"
  spec.version       = Quicken::Git::VERSION
  spec.authors       = ["Matteo Joliveau"]
  spec.email         = ["matteo.joliveau@mikamai.com"]

  spec.summary       = %q{Quicken plugin to initialize Git repositories}
  spec.homepage      = "https://github.com/quicken-rb/quicken-git"
